...
suit_objects = [
      ...
      { name: "Tuxedo", suit_type: "Modern Fit Suit",  description: "These types of suits for men hover squarely in the realm between slim fit and a classic fit. It thereby delivers a tight look with breathing room to spare.", color: Faker::Color.color_name, size: "Small", price: 95, imageUrl: "https://source.unsplash.com//SZoTel1Y4qc" },
